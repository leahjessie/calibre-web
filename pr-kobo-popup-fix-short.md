...
When syncing a Kobo, users see a "Do you want to return to the last page you read?" popup even though they've only been reading on that one device. The answer is always "no"; the position is already correct.
