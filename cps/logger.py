...
def setup(log_file, log_level=None):
    ...
    if log_file == LOG_TO_STDERR or log_file == LOG_TO_STDOUT:
        ...
        try:
            file_handler = RotatingFileHandler(log_file, maxBytes=10000000, backupCount=10, encoding='utf-8')
        except (IOError, PermissionError):
            if log_file == DEFAULT_LOG_FILE:
                raise
            file_handler = RotatingFileHandler(DEFAULT_LOG_FILE, maxBytes=10000000, backupCount=10, encoding='utf-8')
            log_file = ""
